...
sampler = PowerPosteriorSampler(
    density, theta0, dataloader, per_chain_samplers, between_step=1 #, temperatures=[1. for _ in range(num_chains)], between_step=1
)
...
for i in range(sampler.samplers[num_chains-1].model.num_params()):
